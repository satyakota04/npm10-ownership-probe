...
- `.nvmrc` selects Node 20.20.2, which includes npm 10.8.2.
...
2. Initialize the NVM environment used by the build, then run `nvm use "$(cat .nvmrc)"`. Confirm it reports Node 20.20.2 and npm 10.8.2 before installation.
